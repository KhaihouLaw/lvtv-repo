                ...
                <div className="flex justify-between items-center mx-auto md:p-20 p-4 md:flex-row flex-col gap-6">
                    <div className="mx-auto flex justify-center flex-col">
                        <p className="text-justify text-xl indent-8">
                            ...
                            challenges, aiming to create a centralized platform
                            tailored to the needs of Broadcasting students, with
                            a focus on overcoming limitations of current
                            platforms, enhancing content archiving, and
                            providing efficient navigation. This project builds
                            upon the program's foundation of innovation and
                            adaptability, aspiring to create a more cohesive and
                            technologically advanced broadcasting experience for
                            students.
                        </p>
                    </div>
                    ...
                    <div className="mx-auto flex justify-start item-start flex-col space-y-1">
                        ...
                        <div className="flex rounded-sm hover:shadow-lg items-start justify-start h-full">
                            <p className="text-justify font-color indent-8">
                                ...
                                reflects a remarkable story of resilience and
                                adaptation. Despite facing initial challenges
                                and operating within limited resources, the
                                program's pioneering efforts, including the
                                innovative "Pera sa Basura" concept,
                                demonstrated a commitment to creative
                                resourcefulness and marked the first public
                                viewing of student-produced content. As the
                                program evolved, so did its projects, such as
                                the initiative to "Tagalize" movies to fundraise
                                for equipment, leading to the acquisition of a
                    ...
                    <div className="mx-auto flex justify-center flex-col space-y-4 gap-16">
                        ...
                        <div className="flex rounded-sm p-10 hover:shadow-lg items-center justify-center">
                            <p className="text-justify indent-8">
                                ...
                                subsequent exploration of remote broadcasting
                                alternatives during the COVID-19 pandemic
                                underscored the program's adaptability to
                                changing circumstances. Despite setbacks and
                                initial struggles with online platforms,
                                instructors' dedicated efforts and the adoption
                                of software like OBS and VMix enabled the
                                continuation of broadcasts during challenging
                                times. However, with the transition to digital
                                broadcasting came new challenges, particularly
                                regarding copyright enforcement on platforms
                                like Facebook, prompting the exploration of a
                                dedicated live-streaming platform tailored
                                specifically for LVCC's Broadcasting program.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex justify-center flex-col">
                        ...
                        <div className="flex rounded-sm h-auto p-10 hover:shadow-lg items-center justify-center">
                            <h1 className="font-color font text-center px-4 py-2">
                                The institution that Ensures quality learning
                    ...
                    <div className="flex justify-center flex-col">
                        ...
                        <div className="flex rounded-sm h-auto p-10 hover:shadow-lg items-center justify-center">
                            <h1 className="font-color font text-center px-4 py-2">
                                ...
                                <br />
                                from different parts of the country so that they
                                may acquire quality education without the
                                worries of high cost of education. <br />
                                It also aims to alleviate poverty by offering
                                <br />
                                opportunities to poor but determined students to
                                acquire higher quality of education to
                                <br />
                                fulfill their dreams and succeed with God's help
                                and mercy.{" "}
                            </h1>
                        </div>
                    </div>
